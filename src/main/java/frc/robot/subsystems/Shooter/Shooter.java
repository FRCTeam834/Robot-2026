...
public class Shooter extends SubsystemBase{
    ...
    private final ShooterIOInputsAutoLogged inputs = new ShooterIOInputsAutoLogged(); //The IO Layer; Transfers Data; Fills Class w/ Numbers every 20ms
    ...
    public Shooter (ShooterIO io){
        ...
        flywheelSysId = new SysIdRoutine(
